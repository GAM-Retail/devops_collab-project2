System.register(["PosApi/Create/Dialogs", "PosApi/TypeExtensions", "../../Helper/NumberFormattingHelper", "PosApi/Consume/Formatters", "PosApi/Consume/Cart", "PosApi/Consume/ScanResults"], function (exports_1, context_1) {
    ...
    var Dialogs, TypeExtensions_1, NumberFormattingHelper_1, Formatters_1, Cart_1, ScanResults_1, KREGragoOrderDialog;
    ...
    return {
        ...
        execute: function () {
            KREGragoOrderDialog = (function (_super) {
                __extends(KREGragoOrderDialog, _super);
                function KREGragoOrderDialog() {
                    return _super.call(this) || this;
                }
                KREGragoOrderDialog.prototype.onReady = function (element) {
                    var _this = this;
                ...
                KREGragoOrderDialog.prototype.open = function (dataInfo) {
                    var _this = this;
                    this._data = dataInfo;
                ...
                KREGragoOrderDialog.prototype.btnAddClickHandler = function () {
                    var _this = this;
                ...
                KREGragoOrderDialog.prototype.btnCancelClickHandler = function () {
                    this.resolvePromise(null);
                    return true;
                };
                KREGragoOrderDialog.prototype.resolvePromise = function (InfoResult) {
                    if (TypeExtensions_1.ObjectExtensions.isFunction(this._resolve)) {
                        this._resolve(InfoResult);
                        this._resolve = null;
                    }
                };
                KREGragoOrderDialog.prototype.addToCartAsync = function (orderNum, item, price, salesId, mssgComment) {
                    var _this = this;
                ...
                return KREGragoOrderDialog;
            }(Dialogs.ExtensionTemplatedDialogBase));
            exports_1("default", KREGragoOrderDialog);
        }
    };
});
//# sourceMappingURL=C:/Commerce/KRERetailCommerce/Pos/Controls/Grago/KREGragoOrderDialogModule.js.map