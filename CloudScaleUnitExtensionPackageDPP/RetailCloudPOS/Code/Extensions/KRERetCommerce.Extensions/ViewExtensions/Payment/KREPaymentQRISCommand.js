System.register(["PosApi/Extend/Views/PaymentView", "../../Create/Dialogs/KREMessageDialog", "../../DataService/DataServiceRequests.g", "../../Create/Dialogs/KRECardTypeDialog", "PosApi/Consume/Peripherals", "PosApi/Consume/Cart", "PosApi/Entities"], function (exports_1, context_1) {
    "use strict";
    ...
    var PaymentView, KREMessageDialog_1, Messages, KRECardTypeDialog_1, Peripherals_1, Cart_1, Entities_1, KREPaymentQRISCommand;
    ...
    return {
        ...
        execute: function () {
            KREPaymentQRISCommand = (function (_super) {
                __extends(KREPaymentQRISCommand, _super);
                function KREPaymentQRISCommand(context) {
                    var _this = _super.call(this, context) || this;
                    _this.label = "EDC - Qris";
                    _this.id = "paymentConnectQris";
                    _this.extraClass = "iconBank";
                    return _this;
                }
                KREPaymentQRISCommand.prototype.init = function (state) {
                    var _this = this;
                ...
                KREPaymentQRISCommand.prototype.execute = function () {
                    var _this = this;
                ...
                return KREPaymentQRISCommand;
            }(PaymentView.PaymentViewExtensionCommandBase));
            exports_1("default", KREPaymentQRISCommand);
        }
    };
});
//# sourceMappingURL=C:/Commerce/KRERetailCommerce/Pos/ViewExtensions/Payment/KREPaymentQRISCommand.js.map