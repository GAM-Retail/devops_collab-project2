System.register(["PosApi/TypeExtensions", "PosApi/Extend/Triggers/Triggers", "../Controls/DialogSample/MessageDialog", "PosApi/Extend/Triggers/ApplicationTriggers"], function (exports_1, context_1) {
    ...
    var TypeExtensions_1, Triggers_1, MessageDialog_1, Triggers, PreUnlockTerminalTrigger;
        ...
        execute: function () {
            PreUnlockTerminalTrigger = (function (_super) {
                ...
                PreUnlockTerminalTrigger.prototype.execute = function (options) {
                    ...
                    return MessageDialog_1.default.show(this.context, TypeExtensions_1.StringExtensions.format("Executing PreUnlockTerminalTrigger with options {0}.", JSON.stringify(newOptions)))
                        .then(function () {
...
//# sourceMappingURL=C:/Commerce/KRERetailCommerce/Pos/TriggerHandlers/PreUnlockTerminalTrigger.js.map