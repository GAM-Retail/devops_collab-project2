System.register(["PosApi/TypeExtensions", "PosApi/Extend/Triggers/Triggers", "../Controls/DialogSample/MessageDialog", "PosApi/Extend/Triggers/ApplicationTriggers"], function (exports_1, context_1) {
    ...
    var TypeExtensions_1, Triggers_1, MessageDialog_1, Triggers, PreLogOnTrigger;
        ...
        execute: function () {
            PreLogOnTrigger = (function (_super) {
                ...
                PreLogOnTrigger.prototype.execute = function (options) {
                    ...
                    return MessageDialog_1.default.show(this.context, TypeExtensions_1.StringExtensions.format("Executing PreLogOnTrigger with options {0}.", JSON.stringify(newOptions)))
                        .then(function () {
...
//# sourceMappingURL=C:/Commerce/KRERetailCommerce/Pos/TriggerHandlers/PreLogOnTrigger.js.map